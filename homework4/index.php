...
$works = [
    [
        ...
        'date' => 'Апрель 2019 — июнь 2019',
        'description' => 'Подготовка документации для тендеров',
    ],
    
    [
        'name' => 'Инженер ПТО-сметчик с функцией секретаря, офис-менеджера, помощника руководителя (стажировка)',
        'date' => 'Август 2017 — сентябрь 2017',
        'description' => 'составление смет и документации',
    ],
    
    [
    	'name' => 'Инженер ПТО',
        'date' => 'Май 2016 — июнь 2016',
        'description' => 'направление - газификация. составление смет и документации',
    ],
    
    [
    	'name' => 'Мастер строительного участка (практика)',
        'date' => 'Июнь 2014 — июль 2014',
        'description' => 'заполнение документов, расчет заработной платы, чертежи в AutoCAD',
    ],
];
